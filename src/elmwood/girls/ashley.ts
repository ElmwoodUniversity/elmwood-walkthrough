...
ashley.addRecommendedGirls('Tasha', 'Saki', 'Molly')
ashley.addIncompatibleGirls('Chelsea', 'Paris')
...
ashley.addChoices(
    ...[
        ...
        'e2truth2',
        'e2truth2a',
        'e2truth2d', // "I told Ashley I have a crush on her AND Tasha in Truth or Dare!"
        'e2tdshowdickoption',
        'e2tdshowdickoption2', // "I showed her my dick in Truth or Dare"
        'e2tdround7',
        'e2twinhj2',
...
ashley.addSkillRequirements(girls => {
